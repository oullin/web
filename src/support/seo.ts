...
export const DEFAULT_DESCRIPTION =
        'Personal Website of Gustavo Ocanto, Engineering Leader, AI Architect, and Software Engineer.';
...
export function buildKeywords(...entries: Array<string | string[] | null | undefined>): string {
        const baseKeywords = DEFAULT_KEYWORDS.split(',').map((keyword) => keyword.trim()).filter(Boolean);
