<template>
	<div data-testid="resume-page-skeleton" class="animate-pulse" :aria-hidden="showRefreshButton ? 'false' : 'true'">
		<div class="space-y-12 lg:grid lg:grid-cols-2 lg:gap-12 lg:space-y-0">
			...
			<div class="space-y-12">
				...
				<div v-if="showRefreshButton" class="flex justify-center lg:justify-start pt-4">
