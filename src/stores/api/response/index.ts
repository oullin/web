import type { CategoriesCollectionResponse, CategoryResponse } from '@api/response/categories-response.ts';
export type { CategoriesCollectionResponse, CategoryResponse };
